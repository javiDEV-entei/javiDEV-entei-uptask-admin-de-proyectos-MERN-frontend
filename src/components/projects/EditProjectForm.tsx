   ...
   return (
    ...
    <div className='max-w-3xl mx-auto'>
        <h1 className="text-5xl font-black">Editar Proyecto</h1>
          <p className="text-2xl font-light text-gray-500 mt-5">Llena el siguinte formulario para editar el proyecto</p>
        ...
        <nav className='my-5'>
              ...
              <form 
              className='mt-10 bg-white shadow-lg p-10 rounded-lg'onSubmit={handleSubmit(handleForm)}
              noValidate
              >
                <ProjectForm
                 register={register}
